...
%nom_dossier = 'MuHaVi_Camera3_All';%'Mouvements_Leger_All';%'Mouvements_Avec_Deplacement1'; %'Mouvements_Avec_Deplacement1'; %'Mouvements_Leger';
%'Mouvements_Avec_Deplacement'; %'Mouvement_Avec_Deplacement';%'Results_Camera3';
...
%     
    ...
    seuil_predef = 1.4; %.4; %1.55;%0.89; %1.55;
    %disp ('i = ');
    %disp (i);
...
%         disp (l);
 ...
 %           disp (seuil);
  ...
  %              disp ('supper');
    ...
    %         disp (matrix{new_indic, 1});
%             disp (new_indic);
        %    disp (matrix);
      %  disp ('founnnnnnnnnndddddd');
