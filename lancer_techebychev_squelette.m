function [ ] = lancer_techebychev_squelette( matrix, nom_doss, n )
...
nom_doc = strcat('Input_Squeletisation_', nom_doss, '.txt');
Input_slh = fopen(nom_doc,'w');

% fichier de sortie Silhouette
nom_doc = strcat('Output_Squeletisation_', nom_doss, '.txt');
...
for i = 1 : longueur
    ...
    for j = 1 : taille
        ...
        if Matrice_Moment_Squeletisation(i, j) == 0
            ...
            fprintf(Input_slh, ch, Matrice_Moment_Squeletisation(i, j));
